...
from hmlf.algorithms.ssac.policies import SSACPolicy
...
class SSAC(OffPolicyAlgorithm):
    ...
    def learn(
        ...
        tb_log_name: str = "SSAC",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(SSAC, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(SSAC, self)._excluded_save_params() + ["actor", "critic", "critic_target"]
...
register_algorithm_for_wrap_environment(SSAC, wrap_no_wrap)
