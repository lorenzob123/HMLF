...
class PaAcBipedalWalker(gym.Wrapper):
    ...
    def __init__(self, env):
        super().__init__(env)
        self.env = env
        self.action_space = SimpleHybrid((gym.spaces.Discrete(2),
...
if __name__ == "__main__":
    from hmlf import PADDPG, DDPG, PPO, PDQN
    ...
    model = PDQN('MlpPolicy', env=PaAcBipedalWalker(gym.make('BipedalWalker-v3')),  verbose=1, learning_starts=0)
